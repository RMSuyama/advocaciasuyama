...
const ProductHero = () => {
    return (
        <>
            ...
            <section className="min-h-screen flex items-center justify-center py-10 px-4 bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-neutral-900 to-dark snap-start">
                <div className="container mx-auto max-w-3xl text-center">
                    ...
                    >
                        <span className="block text-accent text-[9px] md:text-xs font-bold uppercase tracking-[0.3em] mb-3">
                            Pare por 3 minutos. Leia isso.
                        </span>
                        <h1 className="text-2xl md:text-4xl font-black leading-tight mb-4 tracking-tighter bg-gradient-to-b from-white to-neutral-500 bg-clip-text text-transparent">
            ...
            <section className="min-h-screen flex items-center justify-center py-10 px-4 bg-dark snap-start">
                ...
                >
                    <div className="bg-card border border-white/5 p-6 md:p-8 rounded-[30px] shadow-2xl backdrop-blur-sm group hover:border-white/10 transition-colors duration-700">
                        <h3 className="text-lg md:text-xl font-extrabold mb-6 text-white">
                            Você sente que:
                        </h3>
                        <ul className="space-y-3 mb-8">
                            {[
                                ...
                                <motion.li 
                                    ...
                                    className="flex gap-3 text-xs md:text-sm text-neutral-400 leading-relaxed italic"
                                >
            ...
            <section className="min-h-screen flex items-center justify-center py-10 px-4 bg-dark snap-start">
                ...
                >
                    <div className="text-xl md:text-2xl font-light leading-snug space-y-4">
                        <p>Você não precisa de "mais força de vontade".</p>
                        <p className="text-accent font-medium">
                            Você precisa de <span className="text-lg md:text-xl text-white font-black">clareza, espaço mental e uma nova reorganização interna.</span>
                        </p>
